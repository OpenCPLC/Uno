...
{
  RTC_Alarm_Enable(RTC_ALARM_A, set);
}
...
{
  RTC_Alarm_Enable(RTC_ALARM_B, set);
}
...
static void _RTC_Alarm_Disable(RTC_ALARM_e alarm)
{
  RTC->CR &= ~alarm_mask[alarm];
}
...
{
  _RTC_Alarm_Disable(RTC_ALARM_A);
}

void RTC_Alarm_B_Disable(void)
{
  _RTC_Alarm_Disable(RTC_ALARM_B);
}
...
static bool _RTC_Check_Base(int32_t stamp, int32_t stamp_min, int32_t stamp_max, int32_t stamp_alarm, uint32_t stamp_reload)
{
  if(stamp_min < 0) {
...
{
  return _RTC_Alarm_Check(RTC_ALARM_A, offset_min_sec, offset_max_sec);
}

bool RTC_Check_B(uint32_t offset_min_sec, uint32_t offset_max_sec)
{
  return _RTC_Alarm_Check(RTC_ALARM_B, offset_min_sec, offset_max_sec);
}
